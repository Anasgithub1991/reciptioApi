...
-- Started on 2023-06-22 16:21:34
...
--
-- TOC entry 845 (class 1247 OID 49154)
...
--
-- TOC entry 848 (class 1247 OID 49160)
...
--
-- TOC entry 851 (class 1247 OID 49166)
...
--
-- TOC entry 854 (class 1247 OID 49172)
...
--
-- TOC entry 857 (class 1247 OID 49180)
...
--
-- TOC entry 231 (class 1255 OID 49185)
...
--
-- TOC entry 232 (class 1255 OID 49186)
...
-- Dependencies: 209
-- Name: COLUMN approval_destination.precedence; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.approval_destination.precedence IS 'هذا الحقل يبين تسلسل المفارز في منح الموافقات';


--
-- TOC entry 3468 (class 0 OID 0)
-- Dependencies: 209
-- Name: COLUMN approval_destination.send_sms; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.approval_destination.send_sms IS 'هل ان هذه المفرزة لديها صلاحية ارسال الرسائل النصية';
...
--
-- TOC entry 228 (class 1259 OID 65536)
-- Name: information_office; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.information_office (
    id bigint NOT NULL,
    name text
);


ALTER TABLE public.information_office OWNER TO postgres;

--
-- TOC entry 3473 (class 0 OID 0)
-- Dependencies: 228
-- Name: COLUMN information_office.id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.information_office.id IS 'التسلسل';


--
-- TOC entry 3474 (class 0 OID 0)
-- Dependencies: 228
-- Name: COLUMN information_office.name; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.information_office.name IS 'اسم مكتب المعلومات الذي صدرت منه بطاقة السكن';


--
-- TOC entry 229 (class 1259 OID 65541)
-- Name: informationOffice_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.information_office ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
-- Dependencies: 216
-- Name: COLUMN license_type.approving_party; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.license_type.approving_party IS 'جهة الموافقة على الاصدار ويحتوي على ثلاث جهات: 
1- موافقة وزير
...
-- Dependencies: 221
-- Name: COLUMN requests_details.identity_type; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.requests_details.identity_type IS '1 - حيازة
2-  حيازة وحمل';
...
--
-- TOC entry 230 (class 1259 OID 65542)
-- Name: printer; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.printer AS
 SELECT f.id,
    f.req_id,
    f.license_id,
    f.approval_role,
  ...
  WHERE ((f.completed = 1) AND ((f.quality <> (0)::bit(1)) OR (f.quality IS NULL)) AND ((f.is_print <> 1) OR (f.is_print IS NULL)));
...
-- Dependencies: 222
-- Name: COLUMN subidentity.validity; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.subidentity.validity IS ': الصلاحية وتحتوي على ثلاثة انواع
1- مدقق
2-قانونية
3-مصرح';
...
--
-- TOC entry 3240 (class 2604 OID 49271)
...
--
-- TOC entry 3247 (class 2604 OID 49272)
...
--
-- TOC entry 3253 (class 2604 OID 49274)
...
--
-- TOC entry 3262 (class 2604 OID 49275)
...
--
-- TOC entry 3440 (class 0 OID 49187)
-- Dependencies: 209
-- Data for Name: approval_destination; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.approval_destination (id, destination, role_type, approval_part, precedence, send_sms) VALUES (5, 'التسجيل الجنائي', 1, 2, 2, true);
INSERT INTO public.approval_destination (id, destination, role_type, approval_part, precedence, send_sms) VALUES (7, 'الفحص الطبي', 1, 1, 2, true);
INSERT INTO public.approval_destination (id, destination, role_type, approval_part, precedence, send_sms) VALUES (4, 'الادلة الجنائية', 1, 1, 1, false);
INSERT INTO public.approval_destination (id, destination, role_type, approval_part, precedence, send_sms) VALUES (3, 'البنى التحتية', 1, 2, 1, true);
INSERT INTO public.approval_destination (id, destination, role_type, approval_part, precedence, send_sms) VALUES (2, 'الاستخبارات', 1, 1, 2, true);
INSERT INTO public.approval_destination (id, destination, role_type, approval_part, precedence, send_sms) VALUES (8, 'فحص السلاح', 1, 2, 2, true);


--
-- TOC entry 3442 (class 0 OID 49193)
-- Dependencies: 211
-- Data for Name: approvals; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('9efc8be5-2665-44ff-9002-54bcaeabaa49', '1ac4ba58-99b1-460d-b8ac-63677dcf2312', 2, NULL, 1, 'لايوجد', '121', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 01:27:41.31698+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('3b7d5591-0902-40d8-9d70-b87b1a492c3d', '1ac4ba58-99b1-460d-b8ac-63677dcf2312', 7, 1, 0, 'مخالة قانونية', '1212', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 01:33:24.211211+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('3cf3363d-82e5-485c-b2dd-d8209379d70c', '1ac4ba58-99b1-460d-b8ac-63677dcf2312', 8, NULL, 0, 'غير مطابق', '123', '2023-06-10 00:00:00+03', 'null', '2023-06-16 01:34:24.225437+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('8d83c509-7757-452b-88c4-264db7e9d557', '1ac4ba58-99b1-460d-b8ac-63677dcf2312', 4, NULL, 1, 'لايوجد', '122', '2023-06-23 00:00:00+03', 'لايوجد', '2023-06-16 01:38:32.346904+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('7ba03b63-8e12-488d-8ede-1bf2cbf6ad7a', '1ac4ba58-99b1-460d-b8ac-63677dcf2312', NULL, NULL, 1, 'لايوجد', '12', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 01:41:46.805447+03', 2, NULL, NULL, B'0', NULL, 2, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('bb9a9038-7b75-48ba-8d6a-5d8679d947a5', '8929b616-87b4-4ce2-85b5-41910d2400f6', 7, NULL, 0, 'غير لائق', '12', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 01:52:29.955799+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('4436be5b-810c-49b1-bbf5-98e1de75259e', '8929b616-87b4-4ce2-85b5-41910d2400f6', NULL, NULL, 0, 'حسب الفحص الطبي غير لائق', '12', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 01:53:14.723738+03', 2, NULL, NULL, B'0', NULL, 2, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('89164806-e8d9-4459-94b4-587b6a1f92d5', 'b795b687-2211-4251-b19e-977090a6ac8a', 7, NULL, 1, 'لايوجد', '1212', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 12:30:23.490921+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('94cc41b7-4e62-4186-bfb7-37f1279c849a', 'b795b687-2211-4251-b19e-977090a6ac8a', 8, NULL, 0, 'غير صالح للاستخادم', '12', '2023-06-16 00:00:00+03', 'مرفوض', '2023-06-16 12:31:39.310224+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('0f347187-a3dc-4bc2-82d9-0d6267528298', 'b795b687-2211-4251-b19e-977090a6ac8a', NULL, NULL, 0, 'حسب كتاب رفض فحص السلاح', '12', '2023-06-17 00:00:00+03', 'null', '2023-06-16 12:34:12.787395+03', 2, NULL, NULL, B'0', NULL, 3, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('f3f603cc-c168-43d5-b17f-efeb6e2e4b5f', 'c7e3ef53-0030-4902-bba4-e51bdfb2e8b8', NULL, NULL, 1, 'لايوجد', '12', '2023-06-15 00:00:00+03', 'لايوجد', '2023-06-16 18:10:02.588616+03', 2, NULL, NULL, B'0', NULL, 2, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('f8e3e2d6-f133-4404-add3-287eaf99133c', 'de98b0f7-811b-4e35-a3e7-d2fbc2cd5c39', 7, NULL, 1, 'لايوجد', '12', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 19:20:55.833483+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('61f88e10-3dd2-4252-8e0a-cad3ad078001', 'de98b0f7-811b-4e35-a3e7-d2fbc2cd5c39', 8, 2, 0, 'غير صالح', '12', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 19:27:18.935837+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('4ea68f01-0410-430a-bce6-4192a543f858', 'de98b0f7-811b-4e35-a3e7-d2fbc2cd5c39', NULL, NULL, 1, 'لايوجد', '12', '2023-06-16 00:00:00+03', 'لايوجد', '2023-06-16 19:30:40.03273+03', 2, NULL, NULL, B'0', NULL, 2, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('97158eb4-2e91-42be-9004-2f58262a88de', '0afbd703-e0f8-41f4-b75c-b7847344e607', 7, 1, 1, 'null', '22', '2023-06-14 00:00:00+03', 'لايوجد', '2023-06-18 13:04:12.942249+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('c4805899-2a31-4b0d-8a59-9ce287e0aca9', '0afbd703-e0f8-41f4-b75c-b7847344e607', 8, 2, 1, 'null', '11', '2023-06-15 00:00:00+03', 'لايوجد', '2023-06-18 13:08:58.75857+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('59e6c8dd-e6c7-49b2-b8a5-31089ad78fbf', '0afbd703-e0f8-41f4-b75c-b7847344e607', 4, NULL, 0, 'طرق محلي', '33', '2023-06-22 00:00:00+03', 'null', '2023-06-18 13:19:45.172388+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('15ba91bc-562d-4187-808f-598e470ca554', '0afbd703-e0f8-41f4-b75c-b7847344e607', 4, 1, 1, 'null', '33', '2023-06-22 00:00:00+03', 'تم تسليم السلاح ', '2023-06-18 13:20:15.385501+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('0aa4f95e-17d9-492a-aebd-ac1eea5eaa29', '0afbd703-e0f8-41f4-b75c-b7847344e607', 2, NULL, 1, 'null', '3', '2023-06-16 00:00:00+03', 'null', '2023-06-18 13:30:15.547611+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('225fbc1f-f7b3-4189-8333-5bca320b5936', '0afbd703-e0f8-41f4-b75c-b7847344e607', 5, NULL, 1, 'null', 'null', NULL, 'null', '2023-06-18 13:41:03.871753+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('40e0e438-7b7a-4529-8922-c1a2c4ae623a', '0afbd703-e0f8-41f4-b75c-b7847344e607', 7, NULL, 0, 'لا يصلح', '1212', '2023-06-10 00:00:00+03', 'يبيب', '2023-06-22 10:45:28.929403+03', 2, NULL, NULL, B'0', NULL, NULL, NULL);
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('c3c69411-886e-4ab2-9d98-dd66eeec1894', '0afbd703-e0f8-41f4-b75c-b7847344e607', 7, NULL, 1, 'null', '54454', '2023-06-02 00:00:00+03', 'null', '2023-06-22 11:35:54.674748+03', 2, NULL, NULL, B'0', NULL, NULL, 'null');
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('fa6dfd45-d3df-4d82-bc87-d5e93339d2b1', '0afbd703-e0f8-41f4-b75c-b7847344e607', 3, NULL, 1, 'null', '909', '2023-06-02 00:00:00+03', 'null', '2023-06-22 11:39:16.436189+03', 2, NULL, NULL, B'0', NULL, NULL, 'null');
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('8b695b9e-494e-4363-b4a4-c7401b8f8017', '0afbd703-e0f8-41f4-b75c-b7847344e607', 3, NULL, 0, 'يبيب', '11', '2023-06-03 00:00:00+03', 'null', '2023-06-22 11:41:33.131225+03', 2, NULL, NULL, B'0', NULL, NULL, 'null');
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('64806f69-00e2-48c5-845f-d3c6a17a012a', '0afbd703-e0f8-41f4-b75c-b7847344e607', 7, NULL, 0, 'l', 'null', NULL, 'null', '2023-06-22 11:56:11.099288+03', 2, NULL, NULL, B'0', NULL, NULL, 'null');
INSERT INTO public.approvals (id, req_details_id, approval_dest_id, approval_part, status, reason, booknum, bookdate, note, created_at, created_by, updated_at, updated_by, audit, audit_updated, sub_identity, sms) VALUES ('142398ff-fe9e-4ed0-bbcd-aaf07d4e6891', '0afbd703-e0f8-41f4-b75c-b7847344e607', NULL, NULL, 1, 'حسب كتاب فحص السلاح', '1212', '2023-06-16 00:00:00+03', 'غير صالح', '2023-06-16 12:35:08.209664+03', 2, NULL, NULL, B'0', NULL, 4, NULL);


--
-- TOC entry 3443 (class 0 OID 49201)
-- Dependencies: 212
...
INSERT INTO public.biometric (id, pict, iris, fing_dat, fing_xml, note, created_at, created_by, updated_at, updated_by) VALUES ('29f4c788-d34f-4fb8-995d-905652581487', '21d339d5-0006-4c2d-9716-e9ca83862bdf.jpg', NULL, NULL, NULL, NULL, '2023-06-21 13:18:34.595467+03', 8, '2023-06-21 13:18:34.595467+03', NULL);
INSERT INTO public.biometric (id, pict, iris, fing_dat, fing_xml, note, created_at, created_by, updated_at, updated_by) VALUES ('08943ce7-1f0b-4612-b858-899a760303fb', 'ccb5f497-2db2-424a-a141-fb6a6bdfba2e.jpg', NULL, NULL, NULL, NULL, '2023-06-21 13:19:02.612086+03', 8, '2023-06-21 13:19:02.612086+03', NULL);
INSERT INTO public.biometric (id, pict, iris, fing_dat, fing_xml, note, created_at, created_by, updated_at, updated_by) VALUES ('5258b5e6-93fd-429f-bd45-85f7d937fffc', '41974965-fbad-4d7b-a376-5caddb4009c4.jpg', NULL, NULL, NULL, NULL, '2023-06-21 13:19:19.972374+03', 8, '2023-06-21 13:19:19.972374+03', NULL);
INSERT INTO public.biometric (id, pict, iris, fing_dat, fing_xml, note, created_at, created_by, updated_at, updated_by) VALUES ('70b046a9-14c0-421e-9846-a6ae027de486', '92a9a3e1-67f2-410b-bc0a-822443e7f059.jpg', NULL, NULL, NULL, NULL, '2023-06-21 13:19:27.074929+03', 8, '2023-06-21 13:19:27.074929+03', NULL);


--
-- TOC entry 3444 (class 0 OID 49209)
-- Dependencies: 213
...
--
-- TOC entry 3446 (class 0 OID 49215)
-- Dependencies: 215
...
INSERT INTO public.identification (id, req_det_id, printtime, idnum, expdate, permdate, note, created_at, created_by, updated_at, updated_by, is_print, qr_code, "dataunitID", quality, accountant, is_receive) VALUES ('88c6a8d7-13aa-4bf2-aed4-fbedee42d9a4', 'de98b0f7-811b-4e35-a3e7-d2fbc2cd5c39', '2023-06-10', 8999898, '2023-06-10 00:00:00+03', '2023-06-10 00:00:00+03', 'null', '2023-06-10 00:00:00+03', 1, '2023-06-10 00:00:00+03', 2, 0, NULL, 0, NULL, NULL, B'0');
INSERT INTO public.identification (id, req_det_id, printtime, idnum, expdate, permdate, note, created_at, created_by, updated_at, updated_by, is_print, qr_code, "dataunitID", quality, accountant, is_receive) VALUES ('6d8df306-4b0f-4cf7-b1a5-68417fb48803', 'c7e3ef53-0030-4902-bba4-e51bdfb2e8b8', '2023-06-10', 957509, '2023-06-10 00:00:00+03', '2023-06-10 00:00:00+03', 'null', '2023-06-10 00:00:00+03', 1, '2023-06-10 00:00:00+03', 2, 0, NULL, 0, NULL, NULL, B'0');


--
-- TOC entry 3459 (class 0 OID 65536)
-- Dependencies: 228
-- Data for Name: information_office; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.information_office (id, name) OVERRIDING SYSTEM VALUE VALUES (1, 'مكتب معلومات الرصافة');
INSERT INTO public.information_office (id, name) OVERRIDING SYSTEM VALUE VALUES (2, 'مكتب معلومات الكرخ');
INSERT INTO public.information_office (id, name) OVERRIDING SYSTEM VALUE VALUES (3, 'مكتب معلومات الكرادة');
INSERT INTO public.information_office (id, name) OVERRIDING SYSTEM VALUE VALUES (6, 'مكتب معلومات بغداد الجديدة');
INSERT INTO public.information_office (id, name) OVERRIDING SYSTEM VALUE VALUES (5, 'مكتب معلومات حي العامل');


--
-- TOC entry 3447 (class 0 OID 49224)
-- Dependencies: 216
-- Data for Name: license_type; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.license_type (id, license, approving_party) VALUES (1, 'اصدار جديد', 1);
INSERT INTO public.license_type (id, license, approving_party) VALUES (2, 'تجديد', 2);
INSERT INTO public.license_type (id, license, approving_party) VALUES (6, 'بدل ضائع', 2);
INSERT INTO public.license_type (id, license, approving_party) VALUES (7, 'بدل تالف', 2);
INSERT INTO public.license_type (id, license, approving_party) VALUES (8, 'اضافة سلاج', 3);


--
-- TOC entry 3449 (class 0 OID 49230)
-- Dependencies: 218
...
--
-- TOC entry 3451 (class 0 OID 49236)
-- Dependencies: 220
...
INSERT INTO public.requests (id, name1, name2, name3, name4, surname, profession, birdate, gender_type, cat_id, monam1, monam2, monam3, idnum, pro_id, addresses, phone, note, created_at, created_by, updated_at, updated_by, approv_num, approv_date) VALUES ('19de4c9a-4c16-4130-aebd-fcb1316e566f', 'بريسم', 'زاهر', 'رضيب', 'خزعل', 'البهادلي', 'undefined', '2001-05-16 00:00:00+04', 1, 2, 'رضية', 'فاضل', 'حميد', '67676', 1, 'الرصافة', '0676767', 'null', '2023-06-22 16:18:30.319557+03', NULL, NULL, NULL, NULL, NULL);
INSERT INTO public.requests (id, name1, name2, name3, name4, surname, profession, birdate, gender_type, cat_id, monam1, monam2, monam3, idnum, pro_id, addresses, phone, note, created_at, created_by, updated_at, updated_by, approv_num, approv_date) VALUES ('2061d890-ed65-4667-a6b9-0c487380ed5c', 'هيثم', 'عبدالحسين', 'قاسم', 'محمد', 'العتابي', 'undefined', '1990-01-02 00:00:00+03', 1, 3, 'جميلة', 'راسم', 'حجي', '8999898', 1, 'الكرخ', '07770888', 'null', '2023-06-22 16:18:30.641395+03', NULL, NULL, NULL, NULL, NULL);
INSERT INTO public.requests (id, name1, name2, name3, name4, surname, profession, birdate, gender_type, cat_id, monam1, monam2, monam3, idnum, pro_id, addresses, phone, note, created_at, created_by, updated_at, updated_by, approv_num, approv_date) VALUES ('036cfe46-6b64-4d53-8de7-9b7cb943278b', 'سعد', 'جميل', 'ثابت', 'حارث', 'التميمي', 'undefined', '1992-01-01 00:00:00+03', 1, 2, 'سليمة', 'حميد', 'جاسم', '56565', 1, 'الكرخ', '07779557', 'null', '2023-06-22 16:18:30.648607+03', NULL, NULL, NULL, NULL, NULL);


--
-- TOC entry 3452 (class 0 OID 49243)
-- Dependencies: 221
-- Data for Name: requests_details; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('0afbd703-e0f8-41f4-b75c-b7847344e607', '82e60274-234b-4653-aebd-0295199a0103', 1, 2, 'بريسم', 'زاهر', 'رضيب', 'خزعل', 'البهادلي', 1, 2, '2001-05-16 00:00:00+04', 'رضية', 'فاضل', 'حميد', '67676', '2', '2021-05-15', '123444', 'السيدية', '2022-06-06 00:00:00+03', 2, 'الرصافة', 'دار الازياء', '34', '22', '24', 'الهوية الوظيفية', '12345', '1900-01-01 00:00:00+02:57:36', '0676767', 1, '1111', '24', 'موافق اصوليا', 2, 'anas', '2023-06-16 18:07:09.38+03', 1, NULL, 8, '11', '44', '70b046a9-14c0-421e-9846-a6ae027de486', 'laith khaleel murtadha mousa', 1, 'تم المصادقة', NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('118d3ecd-b9ca-43bb-ae9c-f18a8adcc5e6', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'مثنى', 'هاشم', 'قدوس', 'رويض', 'السامرائي', 1, 2, '1976-02-05 00:00:00+03', 'حبيبة', 'قاسم', 'حسيب', '557575', '2', '2022-01-29', 'null', 'null', NULL, 1, 'الرصافة', 'المدينة', '897', '66', '43', 'null', 'null', NULL, '077986757', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.478796+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('18a272ee-2cf6-4d5e-9c9c-16abe39ae4de', 'e2637a01-afe1-4fcd-818e-7073da2a3c4e', 2, 2, 'ثامر', 'جعفر', 'عباس', 'جواد', 'العامري', 1, 3, '1979-01-01 00:00:00+03', 'سعدية', 'محمد', 'حامد', '67676', '3', '2021-12-31', 'null', 'null', NULL, 1, 'الكرخ', 'مركز الشرطة', '434', '655', '65', 'null', 'null', NULL, '077708654', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:08:03.328198+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('35dde25d-9429-470a-a839-a010f0f07bf9', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'ماجد', 'عزيز', 'صابر', 'راسم', 'العبيدي', 1, 3, '1994-01-05 00:00:00+03', 'زينب', 'حميد', 'سلمان', '5775577', '3', '2019-04-01', 'null', 'null', NULL, 1, 'الرصافة', 'المركز', '909', '99', '9', 'null', 'null', NULL, '0780976', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.454756+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('73fc35de-15d1-46ed-806e-1fa6ba5c73b5', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'نعيم', 'محيسن', 'حمادي', 'راضي', 'الجبوري', 1, 3, '1987-12-03 00:00:00+03', 'علياء', 'باسم', 'حميد', '98898', '2', '2017-01-31', 'null', 'null', NULL, 1, 'الكرخ', 'الجامع', '898', '88', '7', 'null', 'null', NULL, '0770777', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.440036+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('7f61159f-870f-439b-816b-1ea7e3ec3878', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'محمد', 'جميل', 'جمعة', 'محمود', 'الركابي', 1, 3, '1990-06-16 00:00:00+04', 'حنين', 'باسم', 'راضي', '989887987', '3', '2019-02-04', 'null', 'null', NULL, 1, 'الكرخ البياع', 'الجامع', '989', '88', '7', 'null', 'null', NULL, '0778865', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.471534+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('9ac7dd74-6308-40be-809e-41fec4921c5b', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'عبدالرزاق', 'علي', 'حسين', 'محسن', 'الشمري', 1, 3, '1976-04-06 00:00:00+03', 'رزوقة', 'جاسم', 'محمد', '6767676', '2', '2019-01-31', 'null', 'null', NULL, 1, 'الرصافة', 'دار الازياء', '565', '22', '2', 'null', 'null', NULL, '0770776', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.463424+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('b795b687-2211-4251-b19e-977090a6ac8a', '2195ec6b-88c1-471c-862c-880bc07eff14', 1, 2, 'احمد', 'علي', 'راضي', 'حازم', 'التميمي', 1, 1, '2023-06-15 00:00:00+03', 'هدية', 'سعيد', 'محسن', '55768778', '2', '2023-06-08', 'null', 'null', '1900-01-01 00:00:00+02:57:36', 1, 'الكرخ', 'مركز الاطفاء', '335', '353', '223', 'null', 'null', '1900-01-01 00:00:00+02:57:36', '07709998', 2, '12jdg', '24', 'موافق', 0, 'null', '2023-06-16 12:25:27.507+03', 1, NULL, 8, 'لايوجد', '1', '39c4e4dd-0b1f-405e-931e-bb9b83fd10f8', 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('0478a0e1-a090-4544-a97c-5159fbb0228d', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'سلام', 'صالح', 'مهدي', 'عبدالله', 'الخيكاني', 1, 3, '1991-11-04 00:00:00+03', 'ازهار', 'محمد', 'شريف', '56557', '2', '2021-03-31', 'null', 'null', NULL, 1, 'الرصافة', 'الجمعية', '44', '3', '24', 'null', 'null', NULL, '07787868', NULL, 'null', '60', 'null', NULL, 'ww', '2023-06-18 12:04:27.459423+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('059b6984-5e69-4502-8228-7e4e6364886b', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'علاء', 'محمد', 'حسين', 'كاظم', 'الجنابي', 1, 3, '1980-09-02 00:00:00+03', 'سارة', 'جاسم', 'سالم', '787878', '3', '2021-06-15', 'null', 'null', NULL, 1, 'الكرخ', 'المول', '898', '87', '7', 'null', 'null', NULL, '07700755', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.430031+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('bb2f5c95-577b-4e1f-9498-dd805a07c265', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'علي', 'عبدالعزيز', 'عبد', 'جبار', 'الكناني', 1, 3, '1987-04-06 00:00:00+04', 'قبيلة', 'حسين', 'راسم', '98888898', '3', '2021-06-01', 'null', 'null', NULL, 1, 'الرصافة', 'المطعم', '889', '88', '7', 'null', 'null', NULL, '077709', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.46875+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('e2510f9d-3ad4-434f-b60c-8301a6c95b46', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'مرتضى', 'عامر', 'مجيد', 'حميد', 'النعيمي', 1, 3, '1979-02-02 00:00:00+03', 'سليمة', 'حميد', 'خالد', '76767', '3', '2022-12-01', 'null', 'null', NULL, 1, 'الكرخ', 'البنك', '898', '23', '12', 'null', 'null', NULL, '077797979', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.436833+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('c7e3ef53-0030-4902-bba4-e51bdfb2e8b8', '82e60274-234b-4653-aebd-0295199a0103', 1, 2, 'سعيد', 'اسماعيل', 'مزهر', 'سرمد', 'الزبيدي', 1, 1, '1996-06-16 00:00:00+04', 'حمدية', 'راضي', 'سلمان', '957509', '3', '2023-06-15', 'null', 'null', '1900-01-01 00:00:00+02:57:36', 1, 'الكرخ', 'مركز الشرطة', '575', '565', '46', 'الهوية الوظيفية', '1212', '1900-01-01 00:00:00+02:57:36', '0777760', NULL, 'null', '24', 'موافق اصوليا', 1, 'لايوجد', '2023-06-16 18:07:09.361+03', 1, NULL, 8, 'لايوجد', '1', '9acc1399-f607-4a58-8349-2252a6c6f943', 'laith khaleel murtadha mousa', 0, NULL, 1);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('d27d81a4-3194-4f55-8945-cff5c0b1d87b', 'b7b98cf0-e908-40f8-8999-15480b100689', 2, 2, 'علياء', 'حبيب', 'جاسم', 'راضي', 'الخفاجي', 2, 2, '1997-02-01 00:00:00+03', 'سبتية', 'سليم', 'حامد', '676767', '2', '2021-01-15', 'null', 'null', NULL, 1, 'الرصافة', 'دارالازياء', '45', '12', '1', 'null', 'null', NULL, '0787880', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-18 12:04:27.443632+03', 1, NULL, NULL, NULL, NULL, NULL, 'laith khaleel murtadha mousa', 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('de98b0f7-811b-4e35-a3e7-d2fbc2cd5c39', '6488b483-4d5f-45a6-933b-52340120f858', 2, 2, 'هيثم', 'عبدالحسين', 'قاسم', 'محمد', 'العتابي', 1, 3, '1990-01-02 00:00:00+03', 'جميلة', 'راسم', 'حجي', '8999898', '3', '2021-11-30', 'null', 'null', '1900-01-01 00:00:00+02:57:36', 1, 'الكرخ', 'موال المنصور', '787', '77', '7', 'null', 'null', '1900-01-01 00:00:00+02:57:36', '07770888', 2, 'gx12', '24', 'موافق اصوليا', 1, 'null', '2023-06-16 19:15:23.099+03', 1, NULL, 8, 'لايوجد', '1', '4f7af3db-67ff-4457-b454-33ed90500478', 'laith khaleel murtadha mousa', 0, NULL, 2);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('259353ad-de8b-4db9-9e88-33fd3e108792', '82e60274-234b-4653-aebd-0295199a0103', 1, 2, 'بريسم', 'زاهر', 'رضيب', 'خزعل', 'البهادلي', 1, 2, '2001-05-16 00:00:00+04', 'رضية', 'فاضل', 'حميد', '67676', '2', '2021-05-15', 'null', 'null', NULL, 1, 'الرصافة', 'دار الازياء', '34', '24', '24', 'null', 'null', NULL, '0676767', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-22 16:18:30.552331+03', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL);
INSERT INTO public.requests_details (id, req_id, license_id, approval_role, name1, name2, name3, name4, surname, gender_type, cat_id, birdate, monam1, monam2, monam3, idnum, iss_1, issdat1, natnum, iss_2, issdat2, pro_id, addresses, nearplace, mahala, zuqaq, dar, djp, numdet, datedet, phone, weapname_id, weapnum, wea_hold_per, margin_app, completed, note, created_at, created_by, updated_at, updated_by, prev_weapn, archive_num, biometric_id, e_fullname, is_entry, entry_note, identity_type) VALUES ('9fccfed3-0afd-4a84-bb75-7384e9796c32', '6488b483-4d5f-45a6-933b-52340120f858', 2, 2, 'هيثم', 'عبدالحسين', 'قاسم', 'محمد', 'العتابي', 1, 3, '1990-01-02 00:00:00+03', 'جميلة', 'راسم', 'حجي', '8999898', '3', '2021-11-30', 'null', 'null', NULL, 1, 'الكرخ', 'موال المنصور', '787', '77', '7', 'null', 'null', NULL, '07770888', NULL, 'null', '60', 'null', NULL, 'null', '2023-06-22 16:18:30.644655+03', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL);


--
-- TOC entry 3453 (class 0 OID 49250)
-- Dependencies: 222
-- Data for Name: subidentity; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.subidentity (sudid, sudname, sudrultype, validity) OVERRIDING SYSTEM VALUE VALUES (1, 'مفرزة الكرخ', 0, 1);
INSERT INTO public.subidentity (sudid, sudname, sudrultype, validity) OVERRIDING SYSTEM VALUE VALUES (3, 'مدقق هويات', 2, 2);
INSERT INTO public.subidentity (sudid, sudname, sudrultype, validity) OVERRIDING SYSTEM VALUE VALUES (4, 'قانونية الهويات', 2, 3);
INSERT INTO public.subidentity (sudid, sudname, sudrultype, validity) OVERRIDING SYSTEM VALUE VALUES (5, 'ادارة الهويات', 0, 1);
INSERT INTO public.subidentity (sudid, sudname, sudrultype, validity) OVERRIDING SYSTEM VALUE VALUES (6, 'مفرزة الرصافة', 0, 3);
INSERT INTO public.subidentity (sudid, sudname, sudrultype, validity) OVERRIDING SYSTEM VALUE VALUES (2, 'مصرح هويات', 3, 2);


--
-- TOC entry 3455 (class 0 OID 49256)
-- Dependencies: 224
...
--
-- TOC entry 3457 (class 0 OID 49265)
-- Dependencies: 226
-- Data for Name: weapon_name; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.weapon_name (id, weapon_name, weapon_size) VALUES (1, 'بيرتا', '9mm');
INSERT INTO public.weapon_name (id, weapon_name, weapon_size) VALUES (2, 'كلوك', '9mm');
INSERT INTO public.weapon_name (id, weapon_name, weapon_size) VALUES (3, 'CZ', '9mm');
INSERT INTO public.weapon_name (id, weapon_name, weapon_size) VALUES (4, 'HS', '9mm');
INSERT INTO public.weapon_name (id, weapon_name, weapon_size) VALUES (5, 'ستار', '9mm');
...
-- Dependencies: 229
-- Name: informationOffice_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."informationOffice_id_seq"', 6, true);
...
SELECT pg_catalog.setval('public.license_type_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.weapon_name_id_seq', 5, true);


--
-- TOC entry 3264 (class 2606 OID 49277)
...
--
-- TOC entry 3268 (class 2606 OID 49279)
...
--
-- TOC entry 3270 (class 2606 OID 49281)
...
--
-- TOC entry 3272 (class 2606 OID 49283)
...
--
-- TOC entry 3274 (class 2606 OID 49285)
...
--
-- TOC entry 3276 (class 2606 OID 49287)
...
--
-- TOC entry 3280 (class 2606 OID 49289)
...
--
-- TOC entry 3278 (class 2606 OID 49291)
...
--
-- TOC entry 3282 (class 2606 OID 49293)
...
--
-- TOC entry 3284 (class 2606 OID 49295)
...
--
-- TOC entry 3286 (class 2606 OID 49297)
...
--
-- TOC entry 3288 (class 2606 OID 49299)
...
--
-- TOC entry 3266 (class 2606 OID 49301)
...
--
-- TOC entry 3290 (class 2606 OID 49303)
...
--
-- TOC entry 3292 (class 2606 OID 49304)
...
--
-- TOC entry 3294 (class 2606 OID 49309)
...
--
-- TOC entry 3295 (class 2606 OID 49314)
...
--
-- TOC entry 3296 (class 2606 OID 49319)
...
--
-- TOC entry 3297 (class 2606 OID 49324)
...
--
-- TOC entry 3298 (class 2606 OID 49329)
...
--
-- TOC entry 3293 (class 2606 OID 49334)
...
--
-- TOC entry 3291 (class 2606 OID 49339)
...
--
-- TOC entry 3299 (class 2606 OID 49344)
...
-- Completed on 2023-06-22 16:21:35
